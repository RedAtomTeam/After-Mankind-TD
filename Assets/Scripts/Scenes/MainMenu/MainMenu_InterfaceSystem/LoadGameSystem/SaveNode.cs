...
public class SaveNode : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI dateTMP;   // Ссылка на TextMeshProUGUI для изменения даты сохранения.
    [SerializeField] private TextMeshProUGUI timeTMP;   // Ссылка на TextMeshProUGUI для изменения времени сохранения.
